...
//
//     final quranManzilModel = quranManzilModelFromJson(jsonString);

import 'dart:convert';

QuranManzilModel quranManzilModelFromJson(String str) =>
    QuranManzilModel.fromJson(json.decode(str));

String quranManzilModelToJson(QuranManzilModel data) =>
    json.encode(data.toJson());

class QuranManzilModel {
  int code;
  String status;
  Data data;
  ...
  factory QuranManzilModel.fromJson(Map<String, dynamic> json) =>
      QuranManzilModel(
        code: json["code"],
        status: json["status"],
